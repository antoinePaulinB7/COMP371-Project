...
• Using [SPACE] to fly upwards (movement in y axis).
• Using left [CTRL] to fly downwards (movement in -y axis).
...
***************** WORLD PARTICULARITIES *****************
• UI displaying player controls on the screen.
• A spherical Skybox.
• Terrain generation using perilin noise.
• Recursive hierarchical modelling System is used to design models.
• Building models are generated and stacked to build skyscrapers.
  * Five different models are randomized to create a diverse set of buildings.
• Models: cars and street lamp posts modelized using Blender and imported as OBJs.
• Includes lighting and shadow maps using the two-pass shadow algorithm.
• Collision Handling.
• Models from PA2 are generated statues in the world.
...
[2] “glm - Decompose mat4 into translation and rotation?,” Stack Overflow, 01-Jan-1963. [Online]. 
 Available: https://stackoverflow.com/questions/17918033/glm-decompose-mat4-into-translation-and-rotation. 
...
[8] “#BlueforSudan: Why is social media turning blue for Sudan?”, Aljazeera. [Online] Available: 
 https://www.aljazeera.com/news/2019/06/blueforsudan-social-media-turning-blue-sudan-190613132528243.html. 
 [Accessed: 21-Aug-2020].
...
[12] “Pantone TPG Sheet 13-0851 Minion Yellow - Pantone Canada,” Polycolors. [Online]. 
 Available: https://polycolors.ca/product/pantone-tpg-sheet-13-0851-minion-yellow/. 
 [Accessed: 21-Aug-2020].
...
[18] N. Olsson, E. Frank, “Procedural city generation using Perlin noise”, 
Faculty of Computing Blekinge Institute of Technology SE371 79 Karlskrona, Sweden, 2020. [Accessed 18-Aug-2020].
